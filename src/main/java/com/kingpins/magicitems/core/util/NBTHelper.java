package com.kingpins.magicitems.core.util;
...
public class NBTHelper {
    ...
    public static CompoundNBT toNBT(Object o) {
        ...
        if (o instanceof ShieldOTTTileEntity) {
            return writeShield((ShieldOTTTileEntity) o);
        }
        return null;
    }

    private static CompoundNBT writeShield(ShieldOTTTileEntity o) {
